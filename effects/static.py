...
class Triangle(Effect):
    def __init__(self):
        ...
        self.view_C_2 = PixelArrayView(self.triangle, 90, 60, True)   # 90 - 149
        self.view_A_2 = PixelArrayView(self.triangle, 150, 30, True)  # 150 - 179
        self.view_A_1_index = 0
        self.view_C_1_index = 0
        self.view_A_2_index = 4
        self.view_C_2_index = 4
        self.cmd_A_1 = Command(Command.COMMAND_TYPE_SINGLE_SEGMENT, Command.SECTION_ID_A, bytearray([self.view_A_1_index]), self.view_A_1)
        self.cmd_C_1 = Command(Command.COMMAND_TYPE_SINGLE_SEGMENT, Command.SECTION_ID_C, bytearray([self.view_C_1_index]), self.view_C_1)
        self.cmd_A_2 = Command(Command.COMMAND_TYPE_SINGLE_SEGMENT, Command.SECTION_ID_A, bytearray([self.view_A_2_index]), self.view_A_2)
        self.cmd_C_2 = Command(Command.COMMAND_TYPE_SINGLE_SEGMENT, Command.SECTION_ID_C, bytearray([self.view_C_2_index]), self.view_C_2)
